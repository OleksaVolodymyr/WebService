...
@WebServiceClient(name = "CopterRemoteControllerImpService", 
                  wsdlLocation = "http://localhost:8081/RemoteControll/CopterRemoteControll?wsdl",
...
public class CopterRemoteControllerImpService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8081/RemoteControll/CopterRemoteControll?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CopterRemoteControllerImpService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8081/RemoteControll/CopterRemoteControll?wsdl");
        }
        WSDL_LOCATION = url;
    }
